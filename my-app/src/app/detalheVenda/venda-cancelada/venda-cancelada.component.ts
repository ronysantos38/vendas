...
@Component({
  selector: 'app-venda-cancelada',
  standalone: false,
  
  templateUrl: './venda-cancelada.component.html',
  styleUrl: './venda-cancelada.component.css'
})


export class VendaCanceladaComponent {
  ...
  */
      ...
      this.vendasService.ListarTipVenda('C').subscribe((resultado) => {
