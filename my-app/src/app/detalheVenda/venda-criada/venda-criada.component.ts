...
@Component({
  selector: 'app-venda-criada',
  standalone: false,
  
  templateUrl: './venda-criada.component.html',
  styleUrl: './venda-criada.component.css'
})


export class VendaCriadaComponent {
  ...
  */
      ...
      this.vendasService.ListarTipVenda('S').subscribe((resultado) => {
